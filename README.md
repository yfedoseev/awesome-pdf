...
* [pdf_oxide](https://github.com/yfedoseev/pdf_oxide) ![](https://shields.io/badge/-extract-inactive) ![](https://shields.io/badge/-manipulate-inactive) ![](https://shields.io/badge/-create-inactive): Fast PDF toolkit written in Rust with bindings for Python, Go, JavaScript/TypeScript, C#/.NET, Java, PHP, Ruby, and WASM. Text extraction, image extraction, markdown conversion, PDF creation and editing. MIT/Apache-2.0 licensed.
